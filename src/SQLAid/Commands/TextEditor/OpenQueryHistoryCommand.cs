...
{
    internal sealed class OpenQueryHistoryCommand
    {
        ...
        public static async Task InitializeAsync(SqlAsyncPackage sqlAsyncPackage)
        {
            ...
            var cmdId = new CommandID(PackageGuids.guidCommands, PackageIds.OpenQueryHistoryCommand);
        ...
        {
            System.Diagnostics.Process.Start("explorer.exe", _sqlAsyncPackage.Options.HistoryDirectory);
        }
    }
}